...
/* ════════════════════════════════════════════════════════════
   BUILD PROMPT
════════════════════════════════════════════════════════════ */
function buildPrompt(topic, target, platform, style, format, goal) {
  const platformDesc = {
...
async function generateContent() {
  ...
  try {
    const prompt = buildPrompt(topic, target, platform, style, format, goal);
    ...
    try {
      ...
      const retryPrompt = buildPrompt(topic, target, platform, style, format, goal) +
